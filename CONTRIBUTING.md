...
- Feature branches are cut from `develop` and named `feature/IMCPKIT-<id>-<short-description>`.
- Hotfixes are cut from `main` and named `hotfix/IMCPKIT-<id>-<short-description>`; they merge back into both `main` and `develop`.
